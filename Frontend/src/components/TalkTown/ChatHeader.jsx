        ...
        <div className="p-4 border-b border-zinc-800 flex items-center justify-between bg-black/50 backdrop-blur-md sticky top-0 z-20">
            ...
            <div className="flex items-center gap-2 md:gap-3">
                ...
                <div className="flex items-center gap-3 cursor-pointer group" onClick={onOpenInfo}>
                    ...
                    <div className="w-9 h-9 rounded-full bg-zinc-800 flex items-center justify-center text-xs font-bold border border-zinc-700 group-hover:border-zinc-500 transition relative overflow-hidden">
                        {/* if this is not group then show avatar or first letter */}
                        {!chat.groupChat && chat.avatar ? (
