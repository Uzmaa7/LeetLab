...
//                     />
//                     {/* Radial gradient taaki center text highlight ho */}
...
//                             className="inline-block px-4 py-1.5 mb-8 border border-orange-500/20 bg-orange-500/5 backdrop-blur-xl rounded-full"
//                         >
...
//                         {/* Responsive Heading with Left-to-Right Gradient */}
//                         <h1 className="text-4xl sm:text-6xl md:text-8xl font-black leading-[1.1] mb-8 tracking-tighter">
//                             <span className="bg-gradient-to-r from-white via-white/90 to-orange-500 bg-clip-text text-transparent inline-block">
//                                 Make Logic Permanent.
//                             </span>
//                         </h1>

//                         {/* Responsive Sub-text */}
//                         <p className="text-sm md:text-xl text-zinc-400 max-w-2xl mb-12 leading-relaxed px-2">
//                             From real-time lobbies to collaborative peer learning—we've built a system where you don't just solve problems, you <span className="text-white">discuss, post, and retain</span> them with a community that grows with you.
//                         </p>
...
//                                 whileTap={{ scale: 0.98 }}
//                                 className="w-full sm:w-auto px-10 py-4 bg-orange-500 text-black font-black rounded-full hover:shadow-[0_0_30px_rgba(249,115,22,0.4)] transition-all uppercase tracking-tight"
//                             >
//                                 Get Started Free
//                             </motion.button>
...
//                                 className="w-full sm:w-auto px-10 py-4 border border-white/10 text-white font-bold rounded-full transition-all uppercase tracking-tight"
//                             >
//                                 View Challenges
//                             </motion.button>
//                         </div>
